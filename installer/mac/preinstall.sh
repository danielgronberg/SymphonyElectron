...
compare_versions()
{
    ...
    INSTALLED_VERSION=$(plutil -p /Applications/ManaDLY.app/Contents/Info.plist | awk '/CFBundleShortVersionString/ {print substr($3, 2, length($3)-2)}')
